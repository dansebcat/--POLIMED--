...
public class GUI_Registro extends javax.swing.JFrame {
    ...
    private void txtCedulaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCedulaKeyTyped
        ...
        if(txtCedula.getText().length()>=10){
                evt.consume();
                getToolkit().beep();
                //JOptionPane.showMessageDialog(rootPane,"El campo solo puede contener 10 digitos");
        }
        habilitarBotones();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // TODO add your handling code here:
        polimed.añadirUsuario(new Usuario((String)txtNombre.getText(),(String)txtApellido.getText(),(String)txtCedula.getText(),Integer.parseInt((String)txtEdad.getText()),(String)txtCorreo.getText(),(String) pssClave.getText()));
